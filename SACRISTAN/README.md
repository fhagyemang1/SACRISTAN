...
Every round of work on this project so far has been careful manual
review — this sandbox cannot install the Dart/Flutter SDK, so nothing
here has ever actually been compiled. That's the single biggest risk in
this delivery. The fastest way to close it, with **no local Flutter
install required**, is GitHub Actions:
